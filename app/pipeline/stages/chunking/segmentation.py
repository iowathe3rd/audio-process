...
from app.domain.contracts import ChunkBuilder
from app.models import ChunkRecord, DiarizationSegment
...
class WavChunkBuilder(ChunkBuilder):
    """Builds WAV audio chunks from diarization segments."""
